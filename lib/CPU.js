...
export default class CPU {
    ...
    step() {
        ...
        console.log(`Executing opcode ${Utils.hex_d9(insn)}`);
        switch (insn) {
            // NOP
            case 0x00:
                this.cycles += 1;
            ...
            case 0x0f:
                ...
                this.put((SP + 1) & 0xff, this.PC >> 8);
                this.put(SFR.SP, (SP + 2) & 0xff);
            ...
            case 0x20:
                ...
                SP = this.get(SFR.SP);
                this.put(SP, this.PC & 0xff);
                this.put(Utils.u8(SP - 1), this.PC >>> 8);
