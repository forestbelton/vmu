...
export default class CPU {
    ...
    step() {
        ...
        switch (insn) {
            ...
            case 0x0e:
            case 0x0f:
                const a12 = this.fetch(this.PC++);
                const addr = Utils.a12(insn, a12);

                const SP = this.get(SFR.SP);
